...
describe('File endpoints edge cases', function () {
    ...
    it('returns 404 when trying to delete a non-existent file', function () {
        $encoded = urlencode('nonExistent');
    ...
    it('returns 404 when trying to delete a non-existent directory', function () {
        $encoded = urlencode('nonExistent');
